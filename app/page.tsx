...
export default function Home() {
  const [config, setConfig] = useState<{ token: string; groupId: string } | null>(null)
  ...
  return (
    <main className="container mx-auto py-10 px-4 max-w-4xl">
      ...
      {!config ? (
        <GitLabConfig onConfigSaved={setConfig} />
      ) : (
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold">Group Users</h2>
            <button onClick={() => setConfig(null)} className="text-sm text-gray-500 hover:text-gray-700">
